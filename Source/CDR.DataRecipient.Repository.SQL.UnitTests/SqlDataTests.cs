...
namespace CDR.DataRecipient.Repository.SQL.UnitTests
{
    ...
    public class SqlDataTests
    {
        ...
        [Fact]
        public async Task GetConsentAgrrangement_Success()
        {
            //Arrange
            ...
            //Act
            var data = await consentRepository.GetConsent("92d260c1-a625-41e2-a777-c0af1912a74a");
        ...
        [Fact]
        public async Task GetConsentAgrrangements_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
        ...
        [Fact]
        public async Task PersistConsentAgrrangementsInsert_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
            ...
            string jsonDocument = @"{""_id"":{""$oid"":""613ef5b11a0ee5d9fd426a99""},""DataHolderBrandId"":""804fc2fb-18a7-4235-9a49-2af393d18bc7"",""ClientId"":null,""SharingDuration"":null,""CdrArrangementId"":""92d260c1-a625-41e2-a777-c0af1912a74a"",""IdToken"":null,""AccessToken"":null,""RefreshToken"":null,""ExpiresIn"":null,""Scope"":null,""TokenType"":null,""CreatedOn"":null}";
            ...
            var afterPersistdata = await consentRepository.GetConsent(data.CdrArrangementId);
        ...
        [Fact]
        public async Task PersistConsentAgrrangementsUpdate_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
        ...
        [Fact]
        public async Task ConsentAgrrangementsUpdateTokens_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
            ...
            var data = await consentRepository.GetConsent(cdrArrangementId);
        ...
        [Fact]
        public async Task ConsentAgrrangementsDeleteConsent_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
        ...
        [Fact]
        public async Task ConsentAgrrangementsRevokeConsent_Success()
        {
            //Arrange
            var consentRepository = _serviceProvider.GetRequiredService<IConsentsRepository>();
            var sqliteDataAccess = _serviceProvider.GetRequiredService<ISqlDataAccess>();
            ...
            var afterRevokedata = await consentRepository.GetConsent(data.CdrArrangementId);
